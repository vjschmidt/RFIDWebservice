...
public class QCalculatedInterrogador extends Interrogador {
    ...
    public QCalculatedInterrogador(int[] etiquetas, String division, String qStarter, boolean fieldTest, boolean adjust, String tagSpeed, double expositionDistance, float tagBitrate, int tagBitAmount){
